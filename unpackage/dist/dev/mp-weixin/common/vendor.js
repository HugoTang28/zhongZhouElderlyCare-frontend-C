...
/* 3 */
/*!*************************************************************************!*\
  !*** D:/Github-project/zhongZhouElderlyCare/zzyl-frontend-c/pages.json ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
function flushCallbacks$1(vm) {
    if (vm.__next_tick_callbacks && vm.__next_tick_callbacks.length) {
        if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"zzyl-family","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 42 */
/*!****************************************************************************!*\
  !*** D:/Github-project/zhongZhouElderlyCare/zzyl-frontend-c/api/family.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.familyLogout = familyLogout;
...
function sendCode(phone) {
  return (0, _request.post)('/family/auth/send-code', {
    phone: phone
  });
}
function familyLogin(phone, code) {
  return (0, _request.post)('/family/auth/login', {
    phone: phone,
    code: code
  });
}
function familyLogout() {
  return (0, _request.post)('/family/auth/logout', {});
}

// 业务只读接口
function getElders() {
  return (0, _request.get)('/family/elders');
}
function getVisits() {
  return (0, _request.get)('/family/visits');
}
function getBills() {
  return (0, _request.get)('/family/bills');
}
function getCare() {
  return (0, _request.get)('/family/care');
}
function getMessages() {
  return (0, _request.get)('/family/messages');
}
function getAlarms() {
  return (0, _request.get)('/family/alarms');
}

/***/ }),
/* 43 */
/*!*******************************************************************************!*\
  !*** D:/Github-project/zhongZhouElderlyCare/zzyl-frontend-c/utils/request.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var BASE_URL = 'http://localhost:9996';
function getToken() {
